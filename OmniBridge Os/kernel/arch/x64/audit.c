...
static const char *type_name(uint32_t type)
{
    ...
    /* ★ 第 18A 步 */
    case AUDIT_EV_NET_ACCESS:        return "NET_ACCESS";
    case AUDIT_EV_NET_DENIED:        return "NET_DENIED";
    case AUDIT_EV_NET_SANDBOX_BLOCK: return "NET_SANDBOX_BLOCK";
    /* ★ 第 19 步 */
    case AUDIT_EV_COMPAT_SYSCALL:        return "COMPAT_SYSCALL";
    case AUDIT_EV_COMPAT_SYSCALL_ENOSYS: return "COMPAT_SYSCALL_ENOSYS";
    case AUDIT_EV_COMPAT_FORK:           return "COMPAT_FORK";

    case AUDIT_EV_WIN32_API:             return "WIN32_API";
    case AUDIT_EV_WIN32_API_ENOSYS:      return "WIN32_API_ENOSYS";
    case AUDIT_EV_WIN32_ACCESS_DENIED:   return "WIN32_ACCESS_DENIED";
    case AUDIT_EV_WIN32_LOAD:            return "WIN32_LOAD";
