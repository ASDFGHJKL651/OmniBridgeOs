...
# 合法选项：--needed、--noconfirm、--disable-download-timeout
# 注意：pacman 没有 --retry 选项，重试由 shell 层负责。
PACMAN_OPTS=(
    --needed
    --noconfirm
...
status=0
for cmd in clang lld-link make cmake ninja nasm gdb; do
